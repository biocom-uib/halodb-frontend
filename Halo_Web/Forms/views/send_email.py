...
# Datos de tu cuenta
    ...
    <body>
        ...
        <p>
        <a href='http://127.0.0.1:8000/account/verify?uid={uid}&date={date}' style="padding:10px 15px;background-color:#28a745;color:white;text-decoration:none;border-radius:5px;">
            Activate account
        </a>
        </p>
        <p>Thanks!</p>
